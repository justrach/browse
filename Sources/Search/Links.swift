...
final class Links: NSObject, NSApplicationDelegate {
    ...
    static func writeFeedback() {
        ...
        text.queryItems = [
            URLQueryItem(name: "title", value: "Search by Codegraff feedback"),
            URLQueryItem(name: "body", value: "\n\n—\nSearch by Codegraff \(Updater.version), build \(Updater.build), macOS \(ProcessInfo.processInfo.operatingSystemVersionString)"),
        ]
